...
public class ConsignarServiceTest {
    ...
    void deberia_consignar_exitosamente() {
        ...
        Transaccion resultado = consignarService.ejecutar(
                "5300000001",
                new BigDecimal("300")
        );

        assertNotNull(resultado);
        assertEquals(new BigDecimal("300"), resultado.getMonto());
    ...
    void deberia_lanzar_error_si_cuenta_no_existe() {
        ...
        RuntimeException ex = assertThrows(RuntimeException.class, () ->
                consignarService.ejecutar("5300000001", new BigDecimal("100"))
        );
    ...
    void deberia_lanzar_error_si_monto_es_invalido() {
        ...
        RuntimeException ex = assertThrows(RuntimeException.class, () ->
                consignarService.ejecutar("5300000001", BigDecimal.ZERO)
        );
